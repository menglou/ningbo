...
using BuilingTest.model;
using BuilingTest.until;
using System.Xml;
using BuilingTest.ServiceReference1;
using System.Data;
using NLog;

namespace BuilingTest
{
    class Program
    {
        public static string uuid = ConfigurationManager.AppSettings["uuid"].ToString();
        static BuilingTest.until.BuildingClientServiceHelper servicehelper = new until.BuildingClientServiceHelper();
        static Logger logger = NLog.LogManager.GetLogger("test");
